...
N4 G0 G90 G54 X0.0 Y0.0 Z10.0 A0 S3000 M3 F600; Fixed cycle (roughing), use work coordinate system, move to first coordinate, don't use A axis, spindle speed 3000 rpm, spindle on, feedrate 600 mm/min]
...
N8 X0.0 Y0.0 
N9 Z0.1 
N10 Z-3.5 F5.0; Drilling hole at (0, 0)
N11 Z10.0 F600.0
( Done )
